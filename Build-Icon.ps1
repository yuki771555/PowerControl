...
function New-IconPng {
    ...
    try {
        ...
        $boltBrush = New-Object Drawing.SolidBrush ([Drawing.Color]::FromArgb(255, 255, 213, 74))
        ...
        foreach ($obj in @($boltBrush, $bolt, $arcPen, $pen, $brush, $path, $graphics, $bitmap, $stream)) {
            if ($obj -ne $null) { $obj.Dispose() }
        }
    }
}
